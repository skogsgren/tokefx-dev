...
\begin{subfigure}{\linewidth}
    \centering
    \makebox[\linewidth][c]{%
        \includegraphics[width=1.25\linewidth]{plots/toksuite/stacked/dose_response_grid_pooled.pdf}
    }
...
\begin{subfigure}{\linewidth}
    \centering
    \makebox[\linewidth][c]{%
        \includegraphics[width=1.25\linewidth]{plots/qwen/stacked/dose_response_grid_pooled.pdf}
    }
